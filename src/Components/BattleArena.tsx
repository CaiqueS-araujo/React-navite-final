...
const styles = StyleSheet.create({
  ...
  fieldHint: { fontFamily: FONT_PIXEL, fontSize: 14, color: "rgba(255,255,255,0.5)" },
  previewRow: {
    flex: 1,
    flexDirection: "row",
    justifyContent: "space-around",
  ...
  resultTitle: { fontFamily: FONT_PIXEL, fontSize: 25, marginBottom: 8, textAlign: "center" },
  resultSub: {
    fontFamily: FONT_PIXEL,
    fontSize: 13,
  ...
  restartText: { fontFamily: FONT_PIXEL, fontSize: 16, color: COLORS.amareloTexto },
  selectTitle: {
    fontFamily: FONT_PIXEL,
    fontSize: 14,
    color: COLORS.amarelo,
  ...
  check: { fontFamily: FONT_PIXEL, fontSize: 16, color: COLORS.amarelo },
  loadingSmall: {
    fontFamily: FONT_PIXEL,
    fontSize: 13,
