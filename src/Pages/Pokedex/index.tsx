...
export function Pokedex() {
    ...
    const handleAddFavorite = async () => {
        ...
        try {
            ...
            Alert.alert(
                "Sucesso!",
                `${pokemon.name.toUpperCase()} foi salvo na nuvem!`
            );
        } catch (err) {
    ...
    const handleRemoveFavorite = async (idToRemove: string) => {
        try {
            ...
            setFavorites((prev) =>
                prev.filter((fav) => fav.id !== idToRemove)
            );
        } catch (err) {
    ...
    const handleUpdateFavorite = async (
        ...
        try {
            const updatedFav = await updateFavorite(
                idToUpdate,
                newNickname
            );
            ...
            setFavorites((prev) =>
                prev.map((fav) =>
                    fav.id === idToUpdate ? updatedFav : fav
                )
            );
        } catch (err) {
